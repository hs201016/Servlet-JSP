	...
	<div class="w3-main" style="margin-left:340px;margin-right:40px">
		...
		<div>
			<div class="w3-container w3-quarter w3-card-2">
				...
				<form action="/Servlet and JSP/MemberJoin.do" method="post">
					<fieldset>
						<input type="text" class="w3-input"  style="width:90%" name="id" id="id" required="" placeholder="아이디">
						<input type="password" class="w3-input" style="width:90%" name="password" id="passwd" required="" placeholder="비밀번호">
						<input type="password" class="w3-input" style="width:90%" name="password2" id="passwd2" requured="" placeholder="비밀번호 확인">
						...
						<input type="text" class="w3-input" style="width:90%" name="studentId" id="studentId" required="" placeholder="학번">
					</fieldset>
